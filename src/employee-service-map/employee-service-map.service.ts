...
@Injectable()
export class EmployeeServiceMapService extends BaseService<EmployeeServiceMap,CreateEmployeeServiceMapDto,UpdateEmployeeServiceMapDto> {
  
  constructor(@InjectRepository(EmployeeServiceMap) private readonly repo:Repository<EmployeeServiceMap> ){
    super(repo,"id", ['emp', 'service'])
  }
}
// ----------------------------------------------------------------------------------------------------------------
// -------------------NORMAL WORKING------------------------
