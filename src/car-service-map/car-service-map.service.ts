...
@Injectable()
export class CarServiceMapService extends BaseService<CarServiceMap,CreateCarServiceMapDto,UpdateCarServiceMapDto> {
  
  constructor(@InjectRepository(CarServiceMap) private readonly repo:Repository<CarServiceMap> ){
    super(repo,"carServiceMapId", ['car', 'service'])
  }
}
// ----------------------------------------------------------------------------------------------------------------
// -------------------NORMAL WORKING------------------------
